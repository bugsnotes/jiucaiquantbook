...
对于想要直接使用小市值策略但又不想从零开发的投资者，可以参考9db量化跟单平台上经过验证的策略。
...
9db平台提供了12个经过严格验证的小市值类策略，这些策略在基础小市值逻辑上进行了多种优化：
