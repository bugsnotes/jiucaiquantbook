# 第十一章：量化策略基础 - 经典案例与实战策略

策略是量化交易的核心。本章系统介绍量化策略的分类、评估方法、经典案例解析（双均线、网格交易、海龟交易法、动量反转、小市值策略）以及9db实战策略精选，帮助你建立从理论到实战的完整知识体系。
...
对于想要直接使用经过验证的小市值策略的投资者，9db量化跟单平台提供了多个经过严格验证的小市值相关策略。

**策略类型**:
这些策略在基础小市值逻辑上进行了多种优化，涵盖：
- 纯小市值策略
- 小市值+价值因子组合
- 小市值+成长因子组合
- 小市值+动量因子组合
...
**详细介绍**:
关于9db平台的完整介绍、13个精选策略的详细信息（包含小市值策略）、收益风险特征、费用标准、使用指南和注意事项，请参阅本章**[第4节《10.4 9db实战策略精选》](#104-实战策略精选---9db量化策略库-)**。
...
**平台地址**: https://www.9db.com/quant?code=08VOdUoq
